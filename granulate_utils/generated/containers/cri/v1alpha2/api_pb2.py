...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=b'Z(k8s.io/cri-api/pkg/apis/runtime/v1alpha2\330\341\036\000\200\342\036\001\310\341\036\001\310\342\036\001\340\342\036\001\320\342\036\001\220\343\036\000',
...
_IDMAPPING = _descriptor.Descriptor(
  name='IDMapping',
  full_name='runtime.v1alpha2.IDMapping',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='host_id', full_name='runtime.v1alpha2.IDMapping.host_id', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='container_id', full_name='runtime.v1alpha2.IDMapping.container_id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='length', full_name='runtime.v1alpha2.IDMapping.length', index=2,
...
_USERNAMESPACE = _descriptor.Descriptor(
  name='UserNamespace',
  full_name='runtime.v1alpha2.UserNamespace',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='mode', full_name='runtime.v1alpha2.UserNamespace.mode', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='uids', full_name='runtime.v1alpha2.UserNamespace.uids', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='gids', full_name='runtime.v1alpha2.UserNamespace.gids', index=2,
...
_NAMESPACEOPTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='userns_options', full_name='runtime.v1alpha2.NamespaceOption.userns_options', index=4,
...
_WINDOWSCONTAINERRESOURCES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rootfs_size_in_bytes', full_name='runtime.v1alpha2.WindowsContainerResources.rootfs_size_in_bytes', index=4,
      number=5, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONTAINERSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='resources', full_name='runtime.v1alpha2.ContainerStatus.resources', index=15,
      number=16, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONTAINERRESOURCES = _descriptor.Descriptor(
  ...
  full_name='runtime.v1alpha2.ContainerResources',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='linux', full_name='runtime.v1alpha2.ContainerResources.linux', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='windows', full_name='runtime.v1alpha2.ContainerResources.windows', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ContainerResources = _reflection.GeneratedProtocolMessageType('ContainerResources', (_message.Message,), {
  ...
  '__module__' : 'v1alpha2.api_pb2'
  # @@protoc_insertion_point(class_scope:runtime.v1alpha2.ContainerResources)
  })
